...
export const Cursor = memo(({
    ...
    const { x, y } = cursor;
    console.log("cursor", name, cursor);

    return (
        <foreignObject /* foreignObject doesn't work correctly with Safari */
            style={{
            ...
            <div
                className="fixed left-6 top-2 px-1.5 py-0.5 rounded-md text-xs text-white font-semibold"
